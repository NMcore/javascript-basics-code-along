...
//Code here
let users = [{ name: 'John', age: 44 },{ name: 'Jake', age: 56 },{ name: 'Jason', age: 46 },{ name: 'Jill', age: 20 }]
...
//Code here
var people = [{ name: 'John', gender: 'male', height: 5.6 },{ name: 'John', gender: 'male', height: 5.6 },{ name: 'John', gender: 'male', height: 5.6 }];
...
let cowboy = {
  name: 'nick',
  state: 'utah',
  favoriteCountrySong: 'happydance',
}
...
//Code here //Question on 12, this one is passing with out without ,launch, is this because of spaceship?
...
// Using the user object provided,(I think this might have been what you missed about object, question here)
...
what about you? Also, the code you posted above isn't quite equal to each other.
b += a  is the same as b = b+a not b = a+a.
b+=a and b = b+a takes the current value of b and then adds a to it.
